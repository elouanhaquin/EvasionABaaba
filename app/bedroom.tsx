...
export default function Bedroom(p_bedroom: Readonly<Ibedroom>) {
    return (
        <div className={"h-4/5 flex w-4/5  pt-6 pb-6"  + ( p_bedroom.cssInversed != undefined && p_bedroom.cssInversed === true ?  " flex-row-reverse m-auto " : " m-auto")} id='Reserver' >

            <div className={" mt-6 w-full grow  "  + ( p_bedroom.cssInversed != undefined && p_bedroom.cssInversed === true ?  " ml-32" : " ")} >
